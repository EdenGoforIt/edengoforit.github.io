---
title: Architecture
description: Software architecture notes, patterns, and .NET design references.
---
...
- [Architectural Patterns](./architectural-pattern.html)
- [Clean Architecture](./clean-architecture.html)
- [.NET Core Clean Architecture](./dot-net-core-clean-architecture.html)
- [Microservices](./micro-service.html)
...
- [Snippet-Markup Architecture folder](https://github.com/EdenGoforIt/Snippet-Markup/tree/main/Architecture)
